...
@onready var playagain_button : Button = $GameOver_Control/GameOver_VBoxContainer/PlayAgain_Button
@onready var exit_button : Button = $GameOver_Control/GameOver_VBoxContainer/Exit_Button
var menu_items = []
